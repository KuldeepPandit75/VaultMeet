...
router.post('/logout', auth_middleware_1.default, userController.logoutUser);
router.put('/update', auth_middleware_1.default, userController.updateUser);
...
router.put('/banner', auth_middleware_1.default, upload.single('banner'), userController.updateBanner);
