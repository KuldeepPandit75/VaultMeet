...
export default function WhyVaultMeet() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300" style={{ backgroundColor: secondaryAccentColor }}>
            ...
            <p className="text-gray-700">From live chat to team creation and submissions — VaultMeet powers every aspect of a modern hackathon.</p>
          </div>
        </div>
      </div>
    </section>
