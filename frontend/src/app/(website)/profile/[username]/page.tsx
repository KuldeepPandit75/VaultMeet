  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto">
        {/* Profile Header */}
        <div className="relative px-8 pt-8 pb-6 -mt-24">
          <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              {/* Username display */}
              {profile?.username && (
                <div className="mt-1 mb-2 flex items-center gap-2 justify-center sm:justify-start">
                  <span className="text-base font-mono text-white/80 bg-black/20 px-3 py-1 rounded-full border border-white/10">
                    @{profile.username}
                  </span>
                </div>
              )}
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  {profile?.featuredProject?.title ? (
                    ...
                    <p className="text-gray-500 italic">No featured projects</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  profile.achievements.split(",").length > 0 ? (
